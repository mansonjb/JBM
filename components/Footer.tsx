    ...
    <footer className="relative overflow-hidden px-0 pt-[clamp(60px,9vh,110px)] pb-[34px]">
      ...
      >
        <div>
          <a
            ...
            className="block font-[family-name:var(--font-display)] text-[clamp(30px,calc(4.4*var(--u)),82px)] leading-[1.06] tracking-[-0.01em] uppercase"
            style={{ color: "#15171C" }}
          >
            {site.email}
          </a>
          <a
            ...
            className="mt-[6px] block font-[family-name:var(--font-display)] text-[clamp(30px,calc(4.4*var(--u)),82px)] leading-[1.06] tracking-[-0.01em] [font-variant-numeric:tabular-nums]"
            style={{ color: "#1F3BD8" }}
          >
            {site.phone}
          </a>
      ...
      <div className="mt-[70px] overflow-hidden pl-[5vw] whitespace-nowrap">
        <div
          ...
          style={{ fontSize: "clamp(150px, calc(40 * var(--u)), 700px)", color: "#15171C" }}
        >
          {site.name}
        </div>
      </div>
