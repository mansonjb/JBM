      ...
      <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[minmax(0,1.35fr)_minmax(0,0.65fr)] lg:gap-[clamp(40px,6vw,100px)]">
        <div className="u-reveal">
          <h2 className="u-display m-0 mb-10 text-[clamp(38px,6vw,104px)]">
            Le consultant recommande. L&apos;agence exécute. Je relie les deux.
          </h2>
          <p className="m-0 max-w-[60ch] text-base leading-[1.65] text-paper/85">
            Je vous accompagne sur les deux versants : le diagnostic, puis la
            mise en œuvre. Pas de rapport transmis à quelqu&apos;un qui
            n&apos;était pas dans la conversation, pas de recommandation que
            personne n&apos;appliquera, pas de sous-traitance. Celui qui
            diagnostique est celui qui exécute, et c&apos;est la seule raison
